...
- **R-FASTAPI-HEALTH-001** MUST: Services MUST implement a /health endpoint returning status information including service state, timestamp, and relevant metrics.
