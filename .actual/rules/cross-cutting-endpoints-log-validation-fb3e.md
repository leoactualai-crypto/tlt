# Standardize Pydantic BaseModel for Input Validation in Logged Service Endpoints: Endpoints Log Validation
...
- **R-PYDANTIC-001** MUST: Endpoints MUST log validation failures and HTTPException raises at error level with sufficient context to correlate with input payloads.
...
<enforcement>
Clause Code MUST NOT skip or defer verification. All new FastAPI endpoints with logging must satisfy these acceptance criteria before merge.
</enforcement>