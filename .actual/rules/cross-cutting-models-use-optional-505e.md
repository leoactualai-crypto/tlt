...
- **R-PYDANTIC-001** MAY: Models MAY use Optional types for nullable fields with explicit default values.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All new API endpoints MUST use Pydantic BaseModel for validation. Code review MUST block merges lacking response_model declarations or using untyped dictionaries for validation.
</enforcement>