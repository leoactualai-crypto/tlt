...
|---|---|
| `monorepo/tlt/**` | `monorepo-tlt-` _(27 ADRs)_ |
| `monorepo/tlt/mcp_services/gateway/**`<br>`monorepo/tlt/mcp_services/rsvp/**`<br>`monorepo/tlt/mcp_services/**` | `monorepo-tlt-mcp-services-` _(18 ADRs)_ |
| `monorepo/tlt/adapters/discord_adapter/**` | `monorepo-tlt-adapters-` _(14 ADRs)_ |
| `monorepo/tlt/nextjs_app/dashboard/**` | `monorepo-tlt-nextjs-app-` _(6 ADRs)_ |
