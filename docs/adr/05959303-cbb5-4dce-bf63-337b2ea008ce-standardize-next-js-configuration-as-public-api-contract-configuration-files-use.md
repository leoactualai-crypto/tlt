...
1. SHOULD: Configuration files SHOULD use TypeScript (next.config.ts) to leverage type checking and IDE support

## Policy Block

- SHOULD Configuration files SHOULD use TypeScript (next.config.ts) to leverage type checking and IDE support
