...
1. SHOULD: Next.js applications SHOULD be organized under dedicated application directories (e.g., nextjs_app/dashboard)

## Policy Block

- SHOULD Next.js applications SHOULD be organized under dedicated application directories (e.g., nextjs_app/dashboard)
