...
1. SHOULD: Teams SHOULD leverage Next.js built-in features (routing, API routes, SSR/SSG) rather than introducing alternative solutions

## Policy Block

- SHOULD Teams SHOULD leverage Next.js built-in features (routing, API routes, SSR/SSG) rather than introducing alternative solutions
