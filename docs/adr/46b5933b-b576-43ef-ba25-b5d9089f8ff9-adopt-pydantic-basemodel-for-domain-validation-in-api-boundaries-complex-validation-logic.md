...
1. MAY: Complex validation logic MAY use Pydantic validators or root_validators for cross-field constraints beyond basic type checking

## Policy Block

- MAY Complex validation logic MAY use Pydantic validators or root_validators for cross-field constraints beyond basic type checking
