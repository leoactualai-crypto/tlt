...
1. SHOULD: Abstract base classes defining node or handler interfaces SHOULD declare async methods to enforce the concurrency contract at the type level

## Policy Block

- SHOULD Abstract base classes defining node or handler interfaces SHOULD declare async methods to enforce the concurrency contract at the type level
