...
1. SHOULD: Complex validation logic SHOULD use Pydantic validators (@validator, @root_validator) to keep validation logic co-located with models

## Policy Block

- SHOULD Complex validation logic SHOULD use Pydantic validators (@validator, @root_validator) to keep validation logic co-located with models
