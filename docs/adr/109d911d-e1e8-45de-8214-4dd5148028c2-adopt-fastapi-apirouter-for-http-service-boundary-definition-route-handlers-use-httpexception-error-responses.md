...
1. MUST: Route handlers MUST use HTTPException for error responses with appropriate HTTP status codes

## Policy Block

- MUST Route handlers MUST use HTTPException for error responses with appropriate HTTP status codes
