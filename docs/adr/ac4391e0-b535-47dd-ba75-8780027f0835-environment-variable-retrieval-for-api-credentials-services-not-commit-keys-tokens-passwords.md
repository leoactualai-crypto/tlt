...
1. MUST_NOT: Services MUST NOT commit API keys, tokens, passwords, or other credentials to version control in any form

## Policy Block

- MUST_NOT Services MUST NOT commit API keys, tokens, passwords, or other credentials to version control in any form
