...
1. MUST: Optional fields MUST be declared with explicit optional type annotations and default values or None

## Policy Block

- MUST Optional fields MUST be declared with explicit optional type annotations and default values or None
