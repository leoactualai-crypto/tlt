...
1. MUST: Request and response contracts MUST be defined as Pydantic BaseModel subclasses with typed fields

## Policy Block

- MUST Request and response contracts MUST be defined as Pydantic BaseModel subclasses with typed fields
