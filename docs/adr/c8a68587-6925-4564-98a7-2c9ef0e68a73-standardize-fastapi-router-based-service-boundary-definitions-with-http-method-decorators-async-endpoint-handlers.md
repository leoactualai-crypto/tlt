...
1. SHOULD: Async endpoint handlers SHOULD be used for I/O-bound operations including external API calls, database queries, and message queue interactions.

## Policy Block

- SHOULD Async endpoint handlers SHOULD be used for I/O-bound operations including external API calls, database queries, and message queue interactions.
