...
1. SHOULD: Logger statements SHOULD include structured context such as task_id, event_id, user_id, or correlation identifiers to enable trace reconstruction

## Policy Block

- SHOULD Logger statements SHOULD include structured context such as task_id, event_id, user_id, or correlation identifiers to enable trace reconstruction
