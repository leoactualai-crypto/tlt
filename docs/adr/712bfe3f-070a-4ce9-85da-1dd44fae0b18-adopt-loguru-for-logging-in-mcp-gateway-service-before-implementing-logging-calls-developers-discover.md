...
1. MUST: Before implementing logging calls, developers MUST discover the project's dependency lock artifact and verify the exact resolved version of the logging library.

## Policy Block

- MUST Before implementing logging calls, developers MUST discover the project's dependency lock artifact and verify the exact resolved version of the logging library.
