...
1. MUST: Components that implement real-time communication boundaries MUST declare async function signatures for all public message-sending interfaces.

## Policy Block

- MUST Components that implement real-time communication boundaries MUST declare async function signatures for all public message-sending interfaces.
