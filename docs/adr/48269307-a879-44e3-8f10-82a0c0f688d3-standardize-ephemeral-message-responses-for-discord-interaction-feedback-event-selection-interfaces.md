...
1. SHOULD: Event selection interfaces (embeds with views) SHOULD use ephemeral=True to keep selection UI private

## Policy Block

- SHOULD Event selection interfaces (embeds with views) SHOULD use ephemeral=True to keep selection UI private
