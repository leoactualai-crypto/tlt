...
1. MUST: Collection fields (Dict, List) MUST use Field(default_factory=dict) or Field(default_factory=list) to prevent mutable default argument bugs

## Policy Block

- MUST Collection fields (Dict, List) MUST use Field(default_factory=dict) or Field(default_factory=list) to prevent mutable default argument bugs
