...
1. MUST: All Discord interaction handlers (command callbacks, modal submissions, button callbacks, select menu callbacks) MUST be declared as async def

## Policy Block

- MUST All Discord interaction handlers (command callbacks, modal submissions, button callbacks, select menu callbacks) MUST be declared as async def
