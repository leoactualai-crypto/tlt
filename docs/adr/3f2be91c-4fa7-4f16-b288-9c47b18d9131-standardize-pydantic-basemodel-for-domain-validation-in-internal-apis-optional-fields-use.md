...
1. SHOULD: Optional fields SHOULD use Optional type hints and default values via Field(default_factory=...) for mutable defaults

## Policy Block

- SHOULD Optional fields SHOULD use Optional type hints and default values via Field(default_factory=...) for mutable defaults
