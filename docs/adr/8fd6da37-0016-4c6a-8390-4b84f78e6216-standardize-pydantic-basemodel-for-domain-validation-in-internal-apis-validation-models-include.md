...
1. SHOULD: Validation models SHOULD include reasoning or metadata fields to support observability and debugging

## Policy Block

- SHOULD Validation models SHOULD include reasoning or metadata fields to support observability and debugging
