...
1. MAY: Route handlers MAY use path parameters, query parameters, and request body parameters with type annotations for automatic validation

## Policy Block

- MAY Route handlers MAY use path parameters, query parameters, and request body parameters with type annotations for automatic validation
