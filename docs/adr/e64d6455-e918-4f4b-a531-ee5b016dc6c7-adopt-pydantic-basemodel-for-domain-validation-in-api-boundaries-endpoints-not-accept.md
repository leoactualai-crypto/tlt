...
1. MUST_NOT: API endpoints MUST NOT accept unvalidated dictionaries or raw JSON without Pydantic model validation

## Policy Block

- MUST_NOT API endpoints MUST NOT accept unvalidated dictionaries or raw JSON without Pydantic model validation
