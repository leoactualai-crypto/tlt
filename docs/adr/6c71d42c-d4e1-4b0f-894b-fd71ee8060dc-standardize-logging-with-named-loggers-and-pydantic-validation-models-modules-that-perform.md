...
1. MUST: All modules that perform logging MUST initialize a named logger using either logging.getLogger(__name__) or from loguru import logger

## Policy Block

- MUST All modules that perform logging MUST initialize a named logger using either logging.getLogger(__name__) or from loguru import logger
