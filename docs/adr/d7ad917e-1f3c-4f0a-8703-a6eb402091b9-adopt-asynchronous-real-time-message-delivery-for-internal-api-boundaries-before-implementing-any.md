...
1. MUST: Before implementing any asynchronous runtime or external client library, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify all async APIs against that version's official documentation

## Policy Block

- MUST Before implementing any asynchronous runtime or external client library, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify all async APIs against that version's official documentation
