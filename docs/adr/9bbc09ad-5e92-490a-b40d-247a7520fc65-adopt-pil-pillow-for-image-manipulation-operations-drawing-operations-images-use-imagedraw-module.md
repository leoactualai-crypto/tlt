...
1. MUST: Drawing operations on images MUST use the ImageDraw module's Draw API to obtain a drawing context before performing shape, text, or overlay operations

## Policy Block

- MUST Drawing operations on images MUST use the ImageDraw module's Draw API to obtain a drawing context before performing shape, text, or overlay operations
