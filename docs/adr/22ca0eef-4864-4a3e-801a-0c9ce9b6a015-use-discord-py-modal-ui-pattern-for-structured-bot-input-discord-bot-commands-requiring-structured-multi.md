...
1. MUST: Discord bot commands requiring structured multi-field user input MUST use discord.ui.Modal for form presentation rather than text parsing or alternative interaction patterns

## Policy Block

- MUST Discord bot commands requiring structured multi-field user input MUST use discord.ui.Modal for form presentation rather than text parsing or alternative interaction patterns
