...
1. MUST_NOT: Service handlers MUST NOT perform manual type coercion or validation that duplicates Pydantic's automatic validation

## Policy Block

- MUST_NOT Service handlers MUST NOT perform manual type coercion or validation that duplicates Pydantic's automatic validation
