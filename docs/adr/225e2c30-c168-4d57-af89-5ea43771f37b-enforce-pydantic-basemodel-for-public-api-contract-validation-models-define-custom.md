...
1. MAY: Models MAY define custom validators using validator decorators for cross-field validation logic

## Policy Block

- MAY Models MAY define custom validators using validator decorators for cross-field validation logic
