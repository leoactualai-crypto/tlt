...
1. MUST: Configuration values MUST be retrieved using os.getenv with appropriate default values for local development

## Policy Block

- MUST Configuration values MUST be retrieved using os.getenv with appropriate default values for local development
