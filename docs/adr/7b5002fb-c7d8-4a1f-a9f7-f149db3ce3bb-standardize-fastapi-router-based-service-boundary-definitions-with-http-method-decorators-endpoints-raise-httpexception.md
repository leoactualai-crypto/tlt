...
1. MUST: All endpoints MUST raise HTTPException with appropriate status codes (404, 500, 503) for error conditions rather than returning unstructured error responses.

## Policy Block

- MUST All endpoints MUST raise HTTPException with appropriate status codes (404, 500, 503) for error conditions rather than returning unstructured error responses.
