...
1. MUST: Integration test assertions MUST validate model instances against expected field values, constraint satisfaction, and serialization round-trip correctness

## Policy Block

- MUST Integration test assertions MUST validate model instances against expected field values, constraint satisfaction, and serialization round-trip correctness
