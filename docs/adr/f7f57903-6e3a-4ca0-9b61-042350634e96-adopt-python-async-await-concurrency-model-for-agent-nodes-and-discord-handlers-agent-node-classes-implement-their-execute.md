...
1. MUST: All agent node classes MUST implement their execute method as async def and return an awaitable that resolves to the updated state

## Policy Block

- MUST All agent node classes MUST implement their execute method as async def and return an awaitable that resolves to the updated state
