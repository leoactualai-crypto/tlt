...
1. MUST: Complex domain models with nested structures MUST compose smaller schema models using typed references, maintaining validation cascades through the object graph

## Policy Block

- MUST Complex domain models with nested structures MUST compose smaller schema models using typed references, maintaining validation cascades through the object graph
