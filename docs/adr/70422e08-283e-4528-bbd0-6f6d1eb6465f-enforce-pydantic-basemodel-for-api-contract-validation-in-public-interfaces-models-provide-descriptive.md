...
1. SHOULD: Models SHOULD provide descriptive Field descriptions for API documentation and include examples in docstrings for complex validation rules.

## Policy Block

- SHOULD Models SHOULD provide descriptive Field descriptions for API documentation and include examples in docstrings for complex validation rules.
