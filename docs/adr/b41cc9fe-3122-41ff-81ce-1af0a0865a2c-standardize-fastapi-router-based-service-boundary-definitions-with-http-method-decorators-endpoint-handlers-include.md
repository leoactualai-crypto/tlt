...
1. MAY: Endpoint handlers MAY include docstrings describing the operation for API documentation generation

## Policy Block

- MAY Endpoint handlers MAY include docstrings describing the operation for API documentation generation
