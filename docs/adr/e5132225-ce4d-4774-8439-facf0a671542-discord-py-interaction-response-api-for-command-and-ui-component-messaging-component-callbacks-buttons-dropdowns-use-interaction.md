...
1. SHOULD: UI component callbacks (buttons, dropdowns) SHOULD use interaction.response.edit_message to update the existing message rather than creating new messages

## Policy Block

- SHOULD UI component callbacks (buttons, dropdowns) SHOULD use interaction.response.edit_message to update the existing message rather than creating new messages
