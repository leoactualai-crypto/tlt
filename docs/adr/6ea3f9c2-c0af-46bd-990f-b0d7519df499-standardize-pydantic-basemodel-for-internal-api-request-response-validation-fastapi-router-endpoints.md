...
1. MUST: FastAPI router endpoints MUST NOT accept untyped Dict or Any parameters for structured request bodies

## Policy Block

- MUST FastAPI router endpoints MUST NOT accept untyped Dict or Any parameters for structured request bodies
