...
1. SHOULD: Log messages SHOULD use formatted string literals to embed runtime values and context.

## Policy Block

- SHOULD Log messages SHOULD use formatted string literals to embed runtime values and context.
