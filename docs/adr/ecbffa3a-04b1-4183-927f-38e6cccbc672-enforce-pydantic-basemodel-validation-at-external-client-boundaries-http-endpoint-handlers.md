...
1. MUST: HTTP endpoint handlers MUST declare request and response models as typed schema objects that are automatically validated by the web framework.

## Policy Block

- MUST HTTP endpoint handlers MUST declare request and response models as typed schema objects that are automatically validated by the web framework.
