...
1. MAY: Validation schemas MAY define custom validators for complex business rules that cannot be expressed through declarative field constraints alone.

## Policy Block

- MAY Validation schemas MAY define custom validators for complex business rules that cannot be expressed through declarative field constraints alone.
