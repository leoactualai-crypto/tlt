...
1. MUST: All domain validation models for internal API contracts MUST inherit from Pydantic BaseModel

## Policy Block

- MUST All domain validation models for internal API contracts MUST inherit from Pydantic BaseModel
