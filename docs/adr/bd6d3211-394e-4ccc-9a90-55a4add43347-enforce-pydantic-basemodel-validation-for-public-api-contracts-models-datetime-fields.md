...
1. SHOULD: Models with datetime fields SHOULD use Field(default_factory=...) for automatic timestamp generation rather than mutable defaults

## Policy Block

- SHOULD Models with datetime fields SHOULD use Field(default_factory=...) for automatic timestamp generation rather than mutable defaults
