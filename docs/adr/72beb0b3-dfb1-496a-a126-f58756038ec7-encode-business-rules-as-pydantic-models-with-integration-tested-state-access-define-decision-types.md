...
1. MUST: Define decision types, ratings, and domain enumerations as typed fields with validation constraints rather than untyped string or integer values.

## Policy Block

- MUST Define decision types, ratings, and domain enumerations as typed fields with validation constraints rather than untyped string or integer values.
