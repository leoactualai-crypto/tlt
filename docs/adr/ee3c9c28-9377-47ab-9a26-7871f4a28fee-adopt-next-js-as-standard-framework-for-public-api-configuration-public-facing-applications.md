...
1. MUST: Public-facing applications MUST use Next.js as the framework for API configuration and routing

## Policy Block

- MUST Public-facing applications MUST use Next.js as the framework for API configuration and routing
