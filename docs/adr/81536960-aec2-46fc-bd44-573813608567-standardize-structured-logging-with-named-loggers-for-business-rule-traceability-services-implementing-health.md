...
1. SHOULD: Services implementing health checks or monitoring endpoints SHOULD log status transitions (healthy, degraded, unhealthy, warning) with timestamp, service name, and diagnostic context to enable operational alerting.

## Policy Block

- SHOULD Services implementing health checks or monitoring endpoints SHOULD log status transitions (healthy, degraded, unhealthy, warning) with timestamp, service name, and diagnostic context to enable operational alerting.
