...
1. MUST: Field constraints including numeric bounds, string patterns, required vs optional semantics, and default values MUST be declared using field descriptor annotations

## Policy Block

- MUST Field constraints including numeric bounds, string patterns, required vs optional semantics, and default values MUST be declared using field descriptor annotations
