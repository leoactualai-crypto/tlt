...
1. MUST: Validation models MUST define explicit field types using typing annotations (str, int, float, datetime, Optional, List, Dict) with no implicit Any types for security-critical fields.

## Policy Block

- MUST Validation models MUST define explicit field types using typing annotations (str, int, float, datetime, Optional, List, Dict) with no implicit Any types for security-critical fields.
