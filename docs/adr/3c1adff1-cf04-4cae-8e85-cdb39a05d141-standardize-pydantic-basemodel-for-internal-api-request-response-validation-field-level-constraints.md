...
1. MUST: Field-level constraints (e.g., ge, le, min_length, max_length) MUST be declared using Pydantic Field descriptors where domain invariants exist

## Policy Block

- MUST Field-level constraints (e.g., ge, le, min_length, max_length) MUST be declared using Pydantic Field descriptors where domain invariants exist
