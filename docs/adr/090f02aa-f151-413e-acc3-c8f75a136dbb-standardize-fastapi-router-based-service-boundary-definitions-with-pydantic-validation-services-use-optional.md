...
1. MAY: Services MAY use Optional fields with default values in request models to support backward compatibility

## Policy Block

- MAY Services MAY use Optional fields with default values in request models to support backward compatibility
