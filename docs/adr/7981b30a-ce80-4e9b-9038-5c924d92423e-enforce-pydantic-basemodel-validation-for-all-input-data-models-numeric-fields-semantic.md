...
1. MUST: Numeric fields with semantic constraints MUST use Pydantic Field validators (ge, le, gt, lt) to enforce bounds (e.g., scores from 0.0 to 1.0, ratings from 1 to 5)

## Policy Block

- MUST Numeric fields with semantic constraints MUST use Pydantic Field validators (ge, le, gt, lt) to enforce bounds (e.g., scores from 0.0 to 1.0, ratings from 1 to 5)
