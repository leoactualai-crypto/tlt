...
1. MUST: All Discord message send operations MUST use async/await syntax (await channel.send(), await thread.send(), await user.send())

## Policy Block

- MUST All Discord message send operations MUST use async/await syntax (await channel.send(), await thread.send(), await user.send())
