...
1. MUST: All Pydantic validation models MUST use descriptive class names ending in Create, Update, Response, or Request to indicate their role in the request/response cycle

## Policy Block

- MUST All Pydantic validation models MUST use descriptive class names ending in Create, Update, Response, or Request to indicate their role in the request/response cycle
