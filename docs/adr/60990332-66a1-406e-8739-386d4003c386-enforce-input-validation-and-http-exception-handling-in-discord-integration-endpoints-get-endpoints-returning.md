...
1. SHOULD: GET endpoints returning event state SHOULD use dict.get() with default values to safely access optional nested structures

## Policy Block

- SHOULD GET endpoints returning event state SHOULD use dict.get() with default values to safely access optional nested structures
