...
1. MUST: All HTTP service endpoints MUST be defined using FastAPI APIRouter instances with explicit HTTP method decorators (@router.get, @router.post, @router.delete, @router.put, @router.patch).

## Policy Block

- MUST All HTTP service endpoints MUST be defined using FastAPI APIRouter instances with explicit HTTP method decorators (@router.get, @router.post, @router.delete, @router.put, @router.patch).
