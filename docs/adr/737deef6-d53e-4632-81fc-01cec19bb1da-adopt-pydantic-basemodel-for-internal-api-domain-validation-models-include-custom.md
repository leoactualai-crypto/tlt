...
1. MAY: Models MAY include custom validators for complex cross-field validation logic that cannot be expressed through declarative constraints

## Policy Block

- MAY Models MAY include custom validators for complex cross-field validation logic that cannot be expressed through declarative constraints
