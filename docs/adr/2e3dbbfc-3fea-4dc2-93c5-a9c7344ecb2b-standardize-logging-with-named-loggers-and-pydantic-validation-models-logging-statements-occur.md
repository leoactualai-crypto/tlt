...
1. MUST: Logging statements MUST occur after input validation has succeeded, not before validation

## Policy Block

- MUST Logging statements MUST occur after input validation has succeeded, not before validation
