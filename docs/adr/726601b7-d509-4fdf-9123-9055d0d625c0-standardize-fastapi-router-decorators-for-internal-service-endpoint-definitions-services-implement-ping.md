...
1. SHOULD: Services SHOULD implement a /ping endpoint for simple load balancer health checks returning minimal response payloads

## Policy Block

- SHOULD Services SHOULD implement a /ping endpoint for simple load balancer health checks returning minimal response payloads
