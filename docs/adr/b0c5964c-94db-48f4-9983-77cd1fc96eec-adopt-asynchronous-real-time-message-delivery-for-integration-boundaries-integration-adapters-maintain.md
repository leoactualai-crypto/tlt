...
1. MAY: Integration adapters MAY maintain in-memory state for active delivery tasks when persistence is not required for recovery

## Policy Block

- MAY Integration adapters MAY maintain in-memory state for active delivery tasks when persistence is not required for recovery
