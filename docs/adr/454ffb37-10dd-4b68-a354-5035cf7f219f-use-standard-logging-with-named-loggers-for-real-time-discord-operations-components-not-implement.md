...
1. MUST_NOT: Components MUST NOT implement custom logging frameworks or wrappers that bypass Python's standard logging module

## Policy Block

- MUST_NOT Components MUST NOT implement custom logging frameworks or wrappers that bypass Python's standard logging module
