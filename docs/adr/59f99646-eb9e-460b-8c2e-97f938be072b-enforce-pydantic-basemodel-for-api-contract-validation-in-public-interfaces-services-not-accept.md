...
1. MUST_NOT: Services MUST NOT accept raw dictionaries or unvalidated JSON payloads directly into business logic without first parsing through a Pydantic model.

## Policy Block

- MUST_NOT Services MUST NOT accept raw dictionaries or unvalidated JSON payloads directly into business logic without first parsing through a Pydantic model.
