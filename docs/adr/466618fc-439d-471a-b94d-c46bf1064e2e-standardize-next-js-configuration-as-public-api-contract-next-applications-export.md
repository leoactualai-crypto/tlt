...
1. MUST: Next.js applications MUST export a configuration object named 'nextConfig' from next.config.ts or next.config.js

## Policy Block

- MUST Next.js applications MUST export a configuration object named 'nextConfig' from next.config.ts or next.config.js
