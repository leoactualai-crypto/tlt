...
1. MAY: Models MAY define custom validators for cross-field constraints or complex business rules beyond basic type and range checks

## Policy Block

- MAY Models MAY define custom validators for cross-field constraints or complex business rules beyond basic type and range checks
