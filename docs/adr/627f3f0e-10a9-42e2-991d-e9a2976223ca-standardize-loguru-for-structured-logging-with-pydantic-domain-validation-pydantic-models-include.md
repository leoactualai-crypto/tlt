...
1. SHOULD: Pydantic models SHOULD include Field constraints (ge, le, description) for numeric scores, confidence values, and bounded parameters

## Policy Block

- SHOULD Pydantic models SHOULD include Field constraints (ge, le, description) for numeric scores, confidence values, and bounded parameters
