...
1. MUST: Endpoints MUST use Pydantic BaseModel subclasses for request body validation with explicit type annotations for message_id (int), emoji (str), user_id (int), and action (str) fields

## Policy Block

- MUST Endpoints MUST use Pydantic BaseModel subclasses for request body validation with explicit type annotations for message_id (int), emoji (str), user_id (int), and action (str) fields
