...
1. SHOULD: Command handlers SHOULD use interaction.response.send_message for initial responses and follow-up messages SHOULD use interaction.followup.send when additional messages are required after the initial response

## Policy Block

- SHOULD Command handlers SHOULD use interaction.response.send_message for initial responses and follow-up messages SHOULD use interaction.followup.send when additional messages are required after the initial response
