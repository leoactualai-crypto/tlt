...
1. MUST: All FastAPI endpoint request and response models MUST inherit from pydantic.BaseModel

## Policy Block

- MUST All FastAPI endpoint request and response models MUST inherit from pydantic.BaseModel
