...
1. MUST: Dashboard applications MUST use Next.js as the core framework, configured via next.config.ts

## Policy Block

- MUST Dashboard applications MUST use Next.js as the core framework, configured via next.config.ts
