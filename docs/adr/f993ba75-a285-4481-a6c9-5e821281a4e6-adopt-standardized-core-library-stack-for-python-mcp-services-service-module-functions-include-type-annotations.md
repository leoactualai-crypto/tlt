...
1. SHOULD: Service module functions SHOULD include type annotations using the typing module for parameters and return values

## Policy Block

- SHOULD Service module functions SHOULD include type annotations using the typing module for parameters and return values
