...
1. MUST: All HTTP endpoint handlers accepting message_id parameters MUST validate the message_id exists in bot.active_events before performing Discord API operations

## Policy Block

- MUST All HTTP endpoint handlers accepting message_id parameters MUST validate the message_id exists in bot.active_events before performing Discord API operations
