...
1. MUST: All message send operations to external real-time messaging platforms MUST use asynchronous await patterns to prevent event loop blocking.

## Policy Block

- MUST All message send operations to external real-time messaging platforms MUST use asynchronous await patterns to prevent event loop blocking.
