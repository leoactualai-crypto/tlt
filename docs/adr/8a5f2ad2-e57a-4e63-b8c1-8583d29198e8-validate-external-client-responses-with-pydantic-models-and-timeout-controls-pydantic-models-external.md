...
1. MUST: Pydantic models for external data MUST include description fields documenting expected semantics and constraints

## Policy Block

- MUST Pydantic models for external data MUST include description fields documenting expected semantics and constraints
