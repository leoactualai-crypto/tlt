...
1. MUST: All service boundary definitions MUST use FastAPI APIRouter instances to declare HTTP endpoints

## Policy Block

- MUST All service boundary definitions MUST use FastAPI APIRouter instances to declare HTTP endpoints
