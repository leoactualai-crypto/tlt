...
1. MUST: The MCP gateway service MUST use Loguru as the logging library implementation.

## Policy Block

- MUST The MCP gateway service MUST use Loguru as the logging library implementation.
