...
1. SHOULD: Logger instances SHOULD use module-level __name__ to enable hierarchical logger configuration and filtering

## Policy Block

- SHOULD Logger instances SHOULD use module-level __name__ to enable hierarchical logger configuration and filtering
