...
1. MUST: The dashboard application MUST use Next.js as its React framework, establishing Next.js as the architectural foundation for routing, rendering, and optimization

## Policy Block

- MUST The dashboard application MUST use Next.js as its React framework, establishing Next.js as the architectural foundation for routing, rendering, and optimization
