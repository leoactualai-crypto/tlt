...
1. SHOULD: Endpoints SHOULD use path parameters for resource identifiers (e.g., /{message_id}, /{reminder_id}) and query parameters for filtering operations.

## Policy Block

- SHOULD Endpoints SHOULD use path parameters for resource identifiers (e.g., /{message_id}, /{reminder_id}) and query parameters for filtering operations.
