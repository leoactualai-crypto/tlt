...
1. MUST: Pydantic BaseModel validation classes used for request/response contracts MUST be defined synchronously and applied before async business rule execution

## Policy Block

- MUST Pydantic BaseModel validation classes used for request/response contracts MUST be defined synchronously and applied before async business rule execution
