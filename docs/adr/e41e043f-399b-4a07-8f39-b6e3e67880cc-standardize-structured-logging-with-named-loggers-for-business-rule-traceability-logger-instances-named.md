...
1. MUST: Logger instances MUST be named using __name__ to preserve module hierarchy, enabling log filtering and routing based on business domain boundaries (adapters.discord_adapter, services.tlt_service, mcp_services).

## Policy Block

- MUST Logger instances MUST be named using __name__ to preserve module hierarchy, enabling log filtering and routing based on business domain boundaries (adapters.discord_adapter, services.tlt_service, mcp_services).
