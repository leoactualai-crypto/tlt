...
1. MUST: API router endpoints MUST declare response_model parameter using Pydantic models to enforce response schema validation

## Policy Block

- MUST API router endpoints MUST declare response_model parameter using Pydantic models to enforce response schema validation
