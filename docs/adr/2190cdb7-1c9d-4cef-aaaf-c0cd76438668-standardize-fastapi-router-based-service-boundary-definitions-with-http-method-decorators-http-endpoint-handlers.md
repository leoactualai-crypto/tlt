...
1. MUST: HTTP endpoint handlers MUST be decorated with router method decorators (@router.post, @router.get, @router.delete, @router.put, @router.patch) specifying the URL path

## Policy Block

- MUST HTTP endpoint handlers MUST be decorated with router method decorators (@router.post, @router.get, @router.delete, @router.put, @router.patch) specifying the URL path
