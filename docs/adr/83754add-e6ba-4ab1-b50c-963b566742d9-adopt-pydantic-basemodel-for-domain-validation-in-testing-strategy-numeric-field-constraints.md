...
1. MUST: Numeric field constraints MUST use Pydantic Field with ge (greater than or equal) and le (less than or equal) parameters where bounds are required (e.g., quality_score: float = Field(ge=0.0, le=1.0))

## Policy Block

- MUST Numeric field constraints MUST use Pydantic Field with ge (greater than or equal) and le (less than or equal) parameters where bounds are required (e.g., quality_score: float = Field(ge=0.0, le=1.0))
