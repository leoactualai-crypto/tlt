...
1. MUST: All HTTP service endpoints MUST be defined using FastAPI APIRouter instances with explicit route decorators (@router.post, @router.get, @router.delete)

## Policy Block

- MUST All HTTP service endpoints MUST be defined using FastAPI APIRouter instances with explicit route decorators (@router.post, @router.get, @router.delete)
