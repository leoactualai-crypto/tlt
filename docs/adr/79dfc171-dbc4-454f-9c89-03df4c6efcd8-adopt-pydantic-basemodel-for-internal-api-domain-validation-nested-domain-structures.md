...
1. SHOULD: Nested domain structures SHOULD be composed using typed references to other validated model classes rather than generic dictionaries

## Policy Block

- SHOULD Nested domain structures SHOULD be composed using typed references to other validated model classes rather than generic dictionaries
