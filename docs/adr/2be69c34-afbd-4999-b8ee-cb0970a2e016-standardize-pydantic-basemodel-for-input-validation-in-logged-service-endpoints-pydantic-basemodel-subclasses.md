...
1. MUST: Pydantic BaseModel subclasses used in logged endpoints MUST include explicit type annotations for all fields (int, str, datetime, float, Optional, List)

## Policy Block

- MUST Pydantic BaseModel subclasses used in logged endpoints MUST include explicit type annotations for all fields (int, str, datetime, float, Optional, List)
