...
1. SHOULD: Logging calls SHOULD use the info-level method for normal operational events, including service startup and configuration confirmation.

## Policy Block

- SHOULD Logging calls SHOULD use the info-level method for normal operational events, including service startup and configuration confirmation.
