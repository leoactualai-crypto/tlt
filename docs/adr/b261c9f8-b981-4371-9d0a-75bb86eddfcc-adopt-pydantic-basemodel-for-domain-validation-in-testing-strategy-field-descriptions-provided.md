...
1. SHOULD: Field descriptions SHOULD be provided using Field(description='...') for models used in external contracts to support API documentation

## Policy Block

- SHOULD Field descriptions SHOULD be provided using Field(description='...') for models used in external contracts to support API documentation
