...
1. MUST: Empty state responses (no events found, no data available) MUST be delivered as ephemeral messages

## Policy Block

- MUST Empty state responses (no events found, no data available) MUST be delivered as ephemeral messages
