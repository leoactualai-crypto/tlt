...
1. MUST: Event handlers for Discord lifecycle events (setup_hook, on_ready, on_guild_join, on_guild_remove, on_reaction_add) MUST be declared as async functions

## Policy Block

- MUST Event handlers for Discord lifecycle events (setup_hook, on_ready, on_guild_join, on_guild_remove, on_reaction_add) MUST be declared as async functions
