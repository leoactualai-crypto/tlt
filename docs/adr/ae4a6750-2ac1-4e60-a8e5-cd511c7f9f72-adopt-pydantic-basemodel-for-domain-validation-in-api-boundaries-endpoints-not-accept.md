...
1. MUST_NOT: Endpoints MUST NOT accept unvalidated dictionaries or primitive types for complex domain objects

## Policy Block

- MUST_NOT Endpoints MUST NOT accept unvalidated dictionaries or primitive types for complex domain objects
