...
1. SHOULD: Schema models representing domain entities SHOULD separate concerns by defining distinct models for creation requests, response payloads, and internal state representations

## Policy Block

- SHOULD Schema models representing domain entities SHOULD separate concerns by defining distinct models for creation requests, response payloads, and internal state representations
