...
1. MUST_NOT: Business rule handlers MUST NOT use blocking I/O operations (synchronous requests.get without timeout, blocking file I/O) within async function bodies

## Policy Block

- MUST_NOT Business rule handlers MUST NOT use blocking I/O operations (synchronous requests.get without timeout, blocking file I/O) within async function bodies
