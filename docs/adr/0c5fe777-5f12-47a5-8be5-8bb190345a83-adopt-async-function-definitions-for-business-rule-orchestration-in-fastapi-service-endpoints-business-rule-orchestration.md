...
1. SHOULD: Business rule orchestration functions SHOULD be named with verb-noun patterns (create_reminder, handle_reaction, process_photo) to indicate their action-oriented nature

## Policy Block

- SHOULD Business rule orchestration functions SHOULD be named with verb-noun patterns (create_reminder, handle_reaction, process_photo) to indicate their action-oriented nature
