...
1. MUST: Domain validation models MUST use Pydantic Field constraints (ge, le, description) for numeric bounds and field documentation

## Policy Block

- MUST Domain validation models MUST use Pydantic Field constraints (ge, le, description) for numeric bounds and field documentation
