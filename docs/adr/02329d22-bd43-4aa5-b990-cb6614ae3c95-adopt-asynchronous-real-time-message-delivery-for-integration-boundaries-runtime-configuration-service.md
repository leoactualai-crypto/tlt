...
1. MUST: Runtime configuration for service URLs and polling intervals MUST be sourced from environment variables with documented fallback defaults

## Policy Block

- MUST Runtime configuration for service URLs and polling intervals MUST be sourced from environment variables with documented fallback defaults
