...
1. MUST: All I/O operations including Discord API calls, message fetching, external service requests, and sleep operations MUST use await with async-compatible libraries

## Policy Block

- MUST All I/O operations including Discord API calls, message fetching, external service requests, and sleep operations MUST use await with async-compatible libraries
