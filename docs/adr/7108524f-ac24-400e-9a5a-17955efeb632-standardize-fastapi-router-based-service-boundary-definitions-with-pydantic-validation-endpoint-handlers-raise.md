...
1. MUST: Endpoint handlers MUST raise HTTPException with appropriate status codes (404, 500, 503) for error conditions rather than returning error objects

## Policy Block

- MUST Endpoint handlers MUST raise HTTPException with appropriate status codes (404, 500, 503) for error conditions rather than returning error objects
