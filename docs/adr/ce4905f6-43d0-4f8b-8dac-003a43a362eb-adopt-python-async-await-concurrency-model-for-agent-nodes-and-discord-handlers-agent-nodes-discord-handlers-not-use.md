...
1. MUST_NOT: Agent nodes and Discord handlers MUST NOT use blocking synchronous I/O operations that would stall the event loop

## Policy Block

- MUST_NOT Agent nodes and Discord handlers MUST NOT use blocking synchronous I/O operations that would stall the event loop
