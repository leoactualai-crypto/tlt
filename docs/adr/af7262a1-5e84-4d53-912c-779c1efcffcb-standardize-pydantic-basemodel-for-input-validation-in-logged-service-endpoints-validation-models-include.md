...
1. SHOULD: Validation models SHOULD include description metadata via Field(description=...) to document field semantics for both validation and logging context

## Policy Block

- SHOULD Validation models SHOULD include description metadata via Field(description=...) to document field semantics for both validation and logging context
