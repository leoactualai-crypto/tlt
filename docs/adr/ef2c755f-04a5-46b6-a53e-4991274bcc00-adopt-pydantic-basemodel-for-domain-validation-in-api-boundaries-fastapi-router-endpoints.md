...
1. MUST: FastAPI router endpoints MUST declare response_model parameter using Pydantic models for automatic response validation and OpenAPI schema generation

## Policy Block

- MUST FastAPI router endpoints MUST declare response_model parameter using Pydantic models for automatic response validation and OpenAPI schema generation
