...
1. SHOULD: Route definitions SHOULD be organized in dedicated route modules separate from business logic implementation

## Policy Block

- SHOULD Route definitions SHOULD be organized in dedicated route modules separate from business logic implementation
