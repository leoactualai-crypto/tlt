...
1. MUST_NOT: Command handlers and UI callbacks MUST NOT use direct channel messaging APIs (channel.send) for initial interaction responses as this bypasses the interaction token contract

## Policy Block

- MUST_NOT Command handlers and UI callbacks MUST NOT use direct channel messaging APIs (channel.send) for initial interaction responses as this bypasses the interaction token contract
