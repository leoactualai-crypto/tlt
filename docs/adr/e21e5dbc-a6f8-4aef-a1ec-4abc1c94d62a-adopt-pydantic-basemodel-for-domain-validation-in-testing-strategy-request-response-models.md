...
1. MUST: Request and response models for FastAPI router endpoints MUST be defined as Pydantic BaseModel subclasses with descriptive class names (e.g., ReminderCreate, ExperienceResponse, PhotoAnalysisOutput)

## Policy Block

- MUST Request and response models for FastAPI router endpoints MUST be defined as Pydantic BaseModel subclasses with descriptive class names (e.g., ReminderCreate, ExperienceResponse, PhotoAnalysisOutput)
