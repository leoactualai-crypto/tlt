# Standardize FastAPI Router Decorators for Internal Service Endpoint Definitions: Services Implement Health
...
1. MUST: Services MUST implement a /health endpoint returning status information including service state, timestamp, and relevant metrics

## Policy Block

- MUST Services MUST implement a /health endpoint returning status information including service state, timestamp, and relevant metrics
