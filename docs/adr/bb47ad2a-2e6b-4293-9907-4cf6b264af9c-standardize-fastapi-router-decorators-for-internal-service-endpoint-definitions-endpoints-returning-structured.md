...
1. SHOULD: Endpoints returning structured data SHOULD specify response_model parameter in router decorators using Pydantic BaseModel classes

## Policy Block

- SHOULD Endpoints returning structured data SHOULD specify response_model parameter in router decorators using Pydantic BaseModel classes
