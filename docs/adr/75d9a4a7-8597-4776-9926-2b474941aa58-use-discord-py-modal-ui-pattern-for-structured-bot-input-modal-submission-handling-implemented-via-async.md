...
1. MUST: Modal submission handling MUST be implemented via async on_submit method receiving discord.Interaction parameter

## Policy Block

- MUST Modal submission handling MUST be implemented via async on_submit method receiving discord.Interaction parameter
