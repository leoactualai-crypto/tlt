...
1. MUST: Event processing workflows MUST validate incoming event payloads against context-specific schemas before state transitions or agent task submission.

## Policy Block

- MUST Event processing workflows MUST validate incoming event payloads against context-specific schemas before state transitions or agent task submission.
