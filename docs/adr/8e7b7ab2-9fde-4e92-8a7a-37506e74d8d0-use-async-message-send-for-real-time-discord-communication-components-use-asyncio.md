...
1. MAY: Components MAY use asyncio task loops (e.g., reminder_check_task.start()) for periodic background operations

## Policy Block

- MAY Components MAY use asyncio task loops (e.g., reminder_check_task.start()) for periodic background operations
