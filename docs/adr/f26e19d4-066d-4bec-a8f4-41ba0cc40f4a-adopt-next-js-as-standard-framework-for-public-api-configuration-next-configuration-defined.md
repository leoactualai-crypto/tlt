...
1. MUST: Next.js configuration MUST be defined in next.config.ts with explicit TypeScript typing

## Policy Block

- MUST Next.js configuration MUST be defined in next.config.ts with explicit TypeScript typing
