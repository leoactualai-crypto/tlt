...
1. MUST: Before instantiating or calling any validation framework class or API, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify all used APIs exist in that version's official documentation

## Policy Block

- MUST Before instantiating or calling any validation framework class or API, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify all used APIs exist in that version's official documentation
