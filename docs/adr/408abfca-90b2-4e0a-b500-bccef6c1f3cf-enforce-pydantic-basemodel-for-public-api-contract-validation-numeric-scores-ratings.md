...
1. MUST: Numeric scores and ratings MUST use Field constraints with ge and le parameters to enforce valid ranges

## Policy Block

- MUST Numeric scores and ratings MUST use Field constraints with ge and le parameters to enforce valid ranges
