...
1. MUST: Encode all business rules as Pydantic BaseModel subclasses with Field constraints specifying description, ge, le, and default values.

## Policy Block

- MUST Encode all business rules as Pydantic BaseModel subclasses with Field constraints specifying description, ge, le, and default values.
