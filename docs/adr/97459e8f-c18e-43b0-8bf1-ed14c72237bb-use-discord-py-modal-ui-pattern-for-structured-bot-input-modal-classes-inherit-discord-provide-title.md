...
1. MUST: Modal classes MUST inherit from discord.ui.Modal and provide a title parameter describing the form purpose

## Policy Block

- MUST Modal classes MUST inherit from discord.ui.Modal and provide a title parameter describing the form purpose
