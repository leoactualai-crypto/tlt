...
1. MUST_NOT: Synchronous blocking calls (time.sleep(), requests.get(), synchronous file I/O) MUST NOT be used within async event handlers or coroutines

## Policy Block

- MUST_NOT Synchronous blocking calls (time.sleep(), requests.get(), synchronous file I/O) MUST NOT be used within async event handlers or coroutines
