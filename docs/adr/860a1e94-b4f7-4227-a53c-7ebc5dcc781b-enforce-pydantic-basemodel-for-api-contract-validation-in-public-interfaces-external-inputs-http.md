...
1. MUST: All external inputs from HTTP requests, CloudEvents, Discord messages, and inter-service calls MUST be validated through Pydantic models before processing.

## Policy Block

- MUST All external inputs from HTTP requests, CloudEvents, Discord messages, and inter-service calls MUST be validated through Pydantic models before processing.
