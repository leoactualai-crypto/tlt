...
1. MUST: Required fields MUST be declared without Optional typing; optional fields MUST use Optional[T] or default values

## Policy Block

- MUST Required fields MUST be declared without Optional typing; optional fields MUST use Optional[T] or default values
