...
1. MUST: All Discord API interactions that involve I/O operations (channel.send(), user.send(), thread.send()) MUST use async/await syntax

## Policy Block

- MUST All Discord API interactions that involve I/O operations (channel.send(), user.send(), thread.send()) MUST use async/await syntax
