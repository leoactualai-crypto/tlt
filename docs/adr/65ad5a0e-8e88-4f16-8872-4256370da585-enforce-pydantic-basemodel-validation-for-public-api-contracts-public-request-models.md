...
1. MUST: All public API request models MUST inherit from pydantic.BaseModel and define explicit field types with type annotations

## Policy Block

- MUST All public API request models MUST inherit from pydantic.BaseModel and define explicit field types with type annotations
