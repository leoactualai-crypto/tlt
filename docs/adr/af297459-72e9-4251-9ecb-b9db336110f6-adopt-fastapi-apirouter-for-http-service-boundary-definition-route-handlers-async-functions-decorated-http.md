...
1. MUST: Route handlers MUST be async functions decorated with HTTP method decorators that specify the endpoint path and response model

## Policy Block

- MUST Route handlers MUST be async functions decorated with HTTP method decorators that specify the endpoint path and response model
