...
1. MUST: All service modules exposing HTTP endpoints MUST implement a /health endpoint returning service status, timestamp, and operational metrics.

## Policy Block

- MUST All service modules exposing HTTP endpoints MUST implement a /health endpoint returning service status, timestamp, and operational metrics.
