...
1. MUST: Before implementing features using Next.js APIs, developers MUST discover the project's dependency lock file, resolve the exact installed version, and verify API compatibility against that version's official documentation

## Policy Block

- MUST Before implementing features using Next.js APIs, developers MUST discover the project's dependency lock file, resolve the exact installed version, and verify API compatibility against that version's official documentation
