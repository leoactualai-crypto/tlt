...
1. MAY: Components MAY include contextual metadata (reminder_id, message_id, guild_id, user_id) in log messages to aid correlation

## Policy Block

- MAY Components MAY include contextual metadata (reminder_id, message_id, guild_id, user_id) in log messages to aid correlation
