...
1. SHOULD: Font loading SHOULD use Next.js font optimization APIs rather than manual font loading

## Policy Block

- SHOULD Font loading SHOULD use Next.js font optimization APIs rather than manual font loading
