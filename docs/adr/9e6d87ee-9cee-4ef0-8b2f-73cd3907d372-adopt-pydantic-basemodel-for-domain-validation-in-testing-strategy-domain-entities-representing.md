...
1. MUST: All domain entities representing external events, agent decisions, API contracts, and workflow states MUST be defined as validation model classes inheriting from a base validation framework

## Policy Block

- MUST All domain entities representing external events, agent decisions, API contracts, and workflow states MUST be defined as validation model classes inheriting from a base validation framework
