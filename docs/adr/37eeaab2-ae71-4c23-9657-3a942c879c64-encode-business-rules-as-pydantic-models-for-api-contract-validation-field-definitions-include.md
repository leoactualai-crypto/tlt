...
1. SHOULD: Field definitions SHOULD include human-readable descriptions that serve as inline documentation for API consumers and code generation tools

## Policy Block

- SHOULD Field definitions SHOULD include human-readable descriptions that serve as inline documentation for API consumers and code generation tools
