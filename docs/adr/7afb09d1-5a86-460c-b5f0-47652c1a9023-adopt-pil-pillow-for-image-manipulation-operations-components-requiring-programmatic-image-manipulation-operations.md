...
1. MUST: All components requiring programmatic image manipulation operations (rendering, drawing, format conversion, pixel-level access) MUST use PIL (Pillow) as the image processing library

## Policy Block

- MUST All components requiring programmatic image manipulation operations (rendering, drawing, format conversion, pixel-level access) MUST use PIL (Pillow) as the image processing library
