...
1. MUST: Integration test endpoints that expose real-time messaging operations MUST use asynchronous function definitions to coordinate HTTP request handling with asynchronous message delivery.

## Policy Block

- MUST Integration test endpoints that expose real-time messaging operations MUST use asynchronous function definitions to coordinate HTTP request handling with asynchronous message delivery.
