...
1. SHOULD: Background tasks such as reminder checks and state monitoring SHOULD use discord.py task decorators or asyncio.create_task() for concurrent execution

## Policy Block

- SHOULD Background tasks such as reminder checks and state monitoring SHOULD use discord.py task decorators or asyncio.create_task() for concurrent execution
