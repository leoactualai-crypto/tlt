...
1. MUST: Success confirmation messages MUST use ephemeral=True to provide private feedback to the command initiator

## Policy Block

- MUST Success confirmation messages MUST use ephemeral=True to provide private feedback to the command initiator
