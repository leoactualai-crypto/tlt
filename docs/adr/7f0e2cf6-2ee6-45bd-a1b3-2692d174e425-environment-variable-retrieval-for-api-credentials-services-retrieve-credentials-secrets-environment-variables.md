...
1. MUST: Services MUST retrieve API credentials and secrets from environment variables at runtime, not hardcode them in source files

## Policy Block

- MUST Services MUST retrieve API credentials and secrets from environment variables at runtime, not hardcode them in source files
