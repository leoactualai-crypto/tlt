...
1. MAY: Validation models MAY use Pydantic validators or root_validators for complex cross-field validation logic that cannot be expressed through Field constraints

## Policy Block

- MAY Validation models MAY use Pydantic validators or root_validators for complex cross-field validation logic that cannot be expressed through Field constraints
