...
1. SHOULD: Adapter components SHOULD coordinate asynchronous message sends with backend state queries using concurrent task patterns to minimize total latency.

## Policy Block

- SHOULD Adapter components SHOULD coordinate asynchronous message sends with backend state queries using concurrent task patterns to minimize total latency.
