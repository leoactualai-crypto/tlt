...
1. SHOULD: Validation models SHOULD separate concerns between create/input models (e.g., ReminderCreate, ExperienceCreate) and response/output models (e.g., ReminderResponse, ExperienceResponse)

## Policy Block

- SHOULD Validation models SHOULD separate concerns between create/input models (e.g., ReminderCreate, ExperienceCreate) and response/output models (e.g., ReminderResponse, ExperienceResponse)
