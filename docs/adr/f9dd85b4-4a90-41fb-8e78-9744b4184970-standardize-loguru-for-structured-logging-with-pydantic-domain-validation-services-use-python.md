...
1. MAY: Services MAY use Python's standard logging module for legacy integrations, but MUST NOT mix loguru and standard logging within the same module

## Policy Block

- MAY Services MAY use Python's standard logging module for legacy integrations, but MUST NOT mix loguru and standard logging within the same module
