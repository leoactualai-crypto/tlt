...
1. MUST: All endpoint response models MUST be declared using the response_model parameter in route decorators

## Policy Block

- MUST All endpoint response models MUST be declared using the response_model parameter in route decorators
