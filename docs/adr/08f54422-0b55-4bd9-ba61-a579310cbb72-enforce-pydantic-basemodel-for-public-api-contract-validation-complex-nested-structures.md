...
1. SHOULD: Complex nested structures SHOULD use default_factory with dict or list constructors rather than mutable default arguments

## Policy Block

- SHOULD Complex nested structures SHOULD use default_factory with dict or list constructors rather than mutable default arguments
