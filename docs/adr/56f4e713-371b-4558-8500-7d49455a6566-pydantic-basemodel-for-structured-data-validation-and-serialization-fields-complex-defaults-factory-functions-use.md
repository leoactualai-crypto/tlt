...
1. SHOULD: Fields with complex defaults or factory functions SHOULD use Field(default_factory=...) to ensure proper instantiation per model instance

## Policy Block

- SHOULD Fields with complex defaults or factory functions SHOULD use Field(default_factory=...) to ensure proper instantiation per model instance
