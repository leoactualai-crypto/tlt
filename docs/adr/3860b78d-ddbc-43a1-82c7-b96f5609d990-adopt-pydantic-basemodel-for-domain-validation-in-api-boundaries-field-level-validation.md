...
1. SHOULD: Field-level validation constraints SHOULD use Pydantic Field with descriptive metadata (ge, le, description) for numeric ranges and bounded values

## Policy Block

- SHOULD Field-level validation constraints SHOULD use Pydantic Field with descriptive metadata (ge, le, description) for numeric ranges and bounded values
