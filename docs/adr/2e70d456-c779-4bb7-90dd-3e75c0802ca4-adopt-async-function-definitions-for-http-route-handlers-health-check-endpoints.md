...
1. MUST: Health check endpoints MUST be implemented as async functions to maintain consistency with the service concurrency model

## Policy Block

- MUST Health check endpoints MUST be implemented as async functions to maintain consistency with the service concurrency model
