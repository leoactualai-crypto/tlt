...
1. MUST: The nextConfig contract MUST be exported as the public API configuration interface

## Policy Block

- MUST The nextConfig contract MUST be exported as the public API configuration interface
