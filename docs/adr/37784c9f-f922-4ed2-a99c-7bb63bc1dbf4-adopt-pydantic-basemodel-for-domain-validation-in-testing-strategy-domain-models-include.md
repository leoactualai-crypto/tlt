...
1. MAY: Domain models MAY include nested Pydantic models or List types for complex structures (e.g., photos: Optional[List[str]])

## Policy Block

- MAY Domain models MAY include nested Pydantic models or List types for complex structures (e.g., photos: Optional[List[str]])
