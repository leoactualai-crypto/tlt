...
1. MAY: Code MAY use direct key access for dictionary fields that are guaranteed present by Pydantic models, BaseModel validation, or internal data structures under full control

## Policy Block

- MAY Code MAY use direct key access for dictionary fields that are guaranteed present by Pydantic models, BaseModel validation, or internal data structures under full control
