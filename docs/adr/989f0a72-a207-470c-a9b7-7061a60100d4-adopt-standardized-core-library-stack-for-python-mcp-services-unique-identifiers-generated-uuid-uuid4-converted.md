...
1. MUST: Unique identifiers MUST be generated using uuid.uuid4() and converted to string representation via str(uuid.uuid4())

## Policy Block

- MUST Unique identifiers MUST be generated using uuid.uuid4() and converted to string representation via str(uuid.uuid4())
