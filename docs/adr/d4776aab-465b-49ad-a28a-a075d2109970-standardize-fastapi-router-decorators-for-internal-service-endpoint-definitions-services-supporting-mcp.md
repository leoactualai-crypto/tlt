...
1. SHOULD: Services supporting MCP protocol SHOULD implement redirect handlers for /mcp requests returning 301 permanent redirects to /mcp/

## Policy Block

- SHOULD Services supporting MCP protocol SHOULD implement redirect handlers for /mcp requests returning 301 permanent redirects to /mcp/
