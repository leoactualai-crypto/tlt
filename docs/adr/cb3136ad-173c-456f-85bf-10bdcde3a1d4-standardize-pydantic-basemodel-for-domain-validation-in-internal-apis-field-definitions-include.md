...
1. MUST: All Field definitions MUST include a description parameter documenting the field's purpose and valid values

## Policy Block

- MUST All Field definitions MUST include a description parameter documenting the field's purpose and valid values
