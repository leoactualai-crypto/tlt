...
1. MUST: MCP service modules MUST use the standardized core library stack: os for environment access, typing for type annotations, datetime for temporal operations, uuid for unique identifier generation, json for data serialization, and loguru for structured logging

## Policy Block

- MUST MCP service modules MUST use the standardized core library stack: os for environment access, typing for type annotations, datetime for temporal operations, uuid for unique identifier generation, json for data serialization, and loguru for structured logging
