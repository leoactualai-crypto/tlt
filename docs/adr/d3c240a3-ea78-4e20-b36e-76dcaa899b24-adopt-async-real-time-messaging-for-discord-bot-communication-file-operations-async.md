...
1. SHOULD: File I/O operations in async contexts SHOULD use aiofiles to maintain non-blocking behavior

## Policy Block

- SHOULD File I/O operations in async contexts SHOULD use aiofiles to maintain non-blocking behavior
