...
1. MUST: All Python services, agents, and adapters MUST use loguru as the logging framework, imported as 'from loguru import logger'

## Policy Block

- MUST All Python services, agents, and adapters MUST use loguru as the logging framework, imported as 'from loguru import logger'
