...
1. MAY: Services MAY extend BaseModel with custom validators for cross-field validation logic

## Policy Block

- MAY Services MAY extend BaseModel with custom validators for cross-field validation logic
