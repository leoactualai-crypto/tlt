...
1. MUST: Before implementing any code that instantiates or serializes Pydantic models, discover the project's dependency lock artifact, resolve the exact installed Pydantic version, and verify all Field configurations, validators, and Config options against that version's official documentation

## Policy Block

- MUST Before implementing any code that instantiates or serializes Pydantic models, discover the project's dependency lock artifact, resolve the exact installed Pydantic version, and verify all Field configurations, validators, and Config options against that version's official documentation
