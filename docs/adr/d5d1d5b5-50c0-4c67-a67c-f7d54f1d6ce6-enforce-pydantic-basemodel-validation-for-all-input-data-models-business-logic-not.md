...
1. MUST_NOT: Business logic MUST NOT accept raw dictionaries or unvalidated JSON for external input; validation MUST occur at deserialization boundaries

## Policy Block

- MUST_NOT Business logic MUST NOT accept raw dictionaries or unvalidated JSON for external input; validation MUST occur at deserialization boundaries
