...
1. MUST: Integration test routers MUST define response models using validation frameworks to enforce contract testing between HTTP endpoints and real-time messaging operations.

## Policy Block

- MUST Integration test routers MUST define response models using validation frameworks to enforce contract testing between HTTP endpoints and real-time messaging operations.
