...
1. MUST: All endpoints MUST specify response_model parameter in the router decorator when returning structured data.

## Policy Block

- MUST All endpoints MUST specify response_model parameter in the router decorator when returning structured data.
