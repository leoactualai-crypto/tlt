...
1. MUST: Domain validation models MUST define explicit field types with constraints using Pydantic Field validators where applicable (e.g., ge, le, description)

## Policy Block

- MUST Domain validation models MUST define explicit field types with constraints using Pydantic Field validators where applicable (e.g., ge, le, description)
