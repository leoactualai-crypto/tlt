...
1. MAY: Global styles MAY be imported directly in root layout components following Next.js CSS handling conventions

## Policy Block

- MAY Global styles MAY be imported directly in root layout components following Next.js CSS handling conventions
