...
1. MUST: Integration boundaries MUST separate HTTP request-response patterns (FastAPI routers) from real-time event-driven patterns (Discord bot lifecycle hooks) with explicit async coordination

## Policy Block

- MUST Integration boundaries MUST separate HTTP request-response patterns (FastAPI routers) from real-time event-driven patterns (Discord bot lifecycle hooks) with explicit async coordination
