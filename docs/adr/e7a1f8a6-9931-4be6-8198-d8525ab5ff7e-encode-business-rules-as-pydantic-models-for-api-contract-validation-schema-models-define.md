...
1. MAY: Schema models MAY define custom validators for cross-field business rules that cannot be expressed through single-field constraints

## Policy Block

- MAY Schema models MAY define custom validators for cross-field business rules that cannot be expressed through single-field constraints
