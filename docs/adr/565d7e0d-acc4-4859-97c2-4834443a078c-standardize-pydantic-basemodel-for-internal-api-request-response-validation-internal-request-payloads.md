...
1. MUST: All internal API request payloads MUST be defined as Pydantic BaseModel subclasses with explicit field type annotations

## Policy Block

- MUST All internal API request payloads MUST be defined as Pydantic BaseModel subclasses with explicit field type annotations
