...
1. SHOULD: Service modules SHOULD organize related endpoints within a single router instance representing a cohesive business capability

## Policy Block

- SHOULD Service modules SHOULD organize related endpoints within a single router instance representing a cohesive business capability
