...
1. SHOULD: Complex domain entities SHOULD separate input models (Create, Update) from output models (Response) to distinguish between mutable and immutable fields

## Policy Block

- SHOULD Complex domain entities SHOULD separate input models (Create, Update) from output models (Response) to distinguish between mutable and immutable fields
