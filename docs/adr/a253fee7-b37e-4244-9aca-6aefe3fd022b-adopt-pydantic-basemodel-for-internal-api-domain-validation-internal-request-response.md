...
1. MUST: All internal API request and response models MUST be defined as classes inheriting from the validation framework's base model class

## Policy Block

- MUST All internal API request and response models MUST be defined as classes inheriting from the validation framework's base model class
