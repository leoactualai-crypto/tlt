...
1. MUST_NOT: Discord adapter components MUST NOT use synchronous blocking calls for message delivery

## Policy Block

- MUST_NOT Discord adapter components MUST NOT use synchronous blocking calls for message delivery
