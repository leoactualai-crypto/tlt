...
1. MAY: Implementations MAY expose multiple HTTP methods for reminder lifecycle management including creation, retrieval, listing, and deletion operations

## Policy Block

- MAY Implementations MAY expose multiple HTTP methods for reminder lifecycle management including creation, retrieval, listing, and deletion operations
