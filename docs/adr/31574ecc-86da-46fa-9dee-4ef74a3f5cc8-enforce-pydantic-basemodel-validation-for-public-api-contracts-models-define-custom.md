...
1. MAY: Models MAY define custom Config classes to control JSON encoding, validation behavior, and schema generation

## Policy Block

- MAY Models MAY define custom Config classes to control JSON encoding, validation behavior, and schema generation
