...
1. MAY: Public event announcements or shared event information MAY use non-ephemeral messages when broadcasting to the channel is the intended behavior

## Policy Block

- MAY Public event announcements or shared event information MAY use non-ephemeral messages when broadcasting to the channel is the intended behavior
