...
1. MUST: Optional fields MUST use Optional[T] type hints and provide explicit default values or default_factory functions

## Policy Block

- MUST Optional fields MUST use Optional[T] type hints and provide explicit default values or default_factory functions
