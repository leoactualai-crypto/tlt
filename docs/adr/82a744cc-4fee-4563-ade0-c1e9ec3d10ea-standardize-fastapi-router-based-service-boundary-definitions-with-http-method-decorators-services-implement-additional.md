...
1. MAY: Services MAY implement additional monitoring endpoints such as /metrics, /status, or /debug for operational visibility beyond basic health checks.

## Policy Block

- MAY Services MAY implement additional monitoring endpoints such as /metrics, /status, or /debug for operational visibility beyond basic health checks.
