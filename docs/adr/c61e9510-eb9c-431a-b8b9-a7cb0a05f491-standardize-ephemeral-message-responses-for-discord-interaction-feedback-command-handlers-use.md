...
1. SHOULD: Command handlers SHOULD use interaction.response.send_message() for initial responses and follow-up methods for subsequent messages

## Policy Block

- SHOULD Command handlers SHOULD use interaction.response.send_message() for initial responses and follow-up methods for subsequent messages
