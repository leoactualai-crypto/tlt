...
1. MUST: Handlers MUST raise HTTPException with status_code=404 when referenced resources (event, guild, channel, message, user) are not found

## Policy Block

- MUST Handlers MUST raise HTTPException with status_code=404 when referenced resources (event, guild, channel, message, user) are not found
