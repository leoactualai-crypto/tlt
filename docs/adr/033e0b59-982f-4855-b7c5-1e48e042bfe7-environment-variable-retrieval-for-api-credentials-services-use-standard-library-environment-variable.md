...
1. MUST: Services MUST use the standard library environment variable access function to retrieve secrets

## Policy Block

- MUST Services MUST use the standard library environment variable access function to retrieve secrets
