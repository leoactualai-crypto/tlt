...
1. SHOULD: Optional fields SHOULD use typing.Optional with default values (None or Field default) to distinguish required from optional parameters

## Policy Block

- SHOULD Optional fields SHOULD use typing.Optional with default values (None or Field default) to distinguish required from optional parameters
