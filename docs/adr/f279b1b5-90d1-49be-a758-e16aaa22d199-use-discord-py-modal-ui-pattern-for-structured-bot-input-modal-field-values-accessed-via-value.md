...
1. MAY: Modal field values MAY be accessed via the value attribute of TextInput instances within the on_submit callback

## Policy Block

- MAY Modal field values MAY be accessed via the value attribute of TextInput instances within the on_submit callback
