...
1. MUST: All message delivery operations at real-time integration boundaries MUST use asynchronous send methods that return awaitable coroutines

## Policy Block

- MUST All message delivery operations at real-time integration boundaries MUST use asynchronous send methods that return awaitable coroutines
