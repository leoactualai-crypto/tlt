...
1. MUST: Numeric fields in validation models MUST use Field constraints (ge, le, gt, lt) where business logic requires bounded values

## Policy Block

- MUST Numeric fields in validation models MUST use Field constraints (ge, le, gt, lt) where business logic requires bounded values
